...
function BFMACM:Start() -- start BFMACM module
	local useSRS = (JTF1.useSRS and BFMACM.useSRS) and MISSIONSRS.Radio.active -- default to not using SRS unless both the server AND the module request it and MISSIONSRS.Radio is true
