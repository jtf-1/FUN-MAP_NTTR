...
:: MOOSE
MKLINK %dynamicscriptpath%Moose.lua "E:\GitHub\MOOSE_INCLUDE\Moose_Include_Static\Moose.lua"
:: MIST
MKLINK %dynamicscriptpath%mist.lua "E:\GitHub\MissionScriptingTools\mist.lua"
:: SKYNET
MKLINK %dynamicscriptpath%skynet-iads-compiled.lua "E:\GitHub\Skynet-IADS\demo-missions\skynet-iads-compiled.lua"
